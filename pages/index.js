      ...
      >
        <section className="min-h-screen bg ">
          ...
          <nav className="py-10 mb-12 flex justify-between ">
            <div className="    hvr-fade ">
              <h1 className="text-3xl text-stone-900 dark:text-stone-100 font-good ">
                J<span className="text-red-600 hover:text-amber-400 ">V</span>R
              </h1>
            </div>
          ...
          {/* {HERO} */}
          <div
            className="text-center p-2 m-10"
            data-aos="zoom-in"
          ...
          <div
            className=" mx-auto relative bg-gradient-to-b from-red-500  to-stone-900  flex justify-center rounded-full  w-70 h-70 mt-10 overflow-hidden md:h-96 md:w-96"
            data-aos="flip-left"
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            {/* {SERVICES} */}
            <div
              className="text-center shadow-lg p-3 pt-16 rounded-xl my-10 "
              data-aos="fade-right"
            >
              <Image
                className="mx-auto "
